...
static int32_t get_TEC(
  const NeQuickG_handle nequick,
  double_t * total_electron_content) {

  clock_t begin = clock();

  return NeQuickG.get_total_electron_content(nequick, total_electron_content);
}
...
int processData(
  ...
  double_t * retElectronContent) {
    ...
    return get_TEC(handle, retElectronContent);
}


int setupAndProcessData(  double_t* solarCoef,
                          uint8_t month, double_t UTC,
                          double_t longitude_degree,
                          double_t latitude_degree,
                          double_t height_meters,
...
//        double_t solarCoef[] = { 0.1, 0.2, 0.3 };
        ret = processData(
                ...
                month, UTC,          //uint8_t month, double_t UTC,
                longitude_degree,                   //double_t longitude_degree,
                latitude_degree,                   //double_t latitude_degree,
                height_meters,                 //double_t height_meters,
                satellite_longitude_degree,                   //double_t satellite_longitude_degree,
                satellite_latitude_degree,                   //double_t satellite_latitude_degree,
                satellite_height_meters,                 //double_t satellite_height_meters,
  ...
  return ret == NEQUICK_OK ? true : false;
}
